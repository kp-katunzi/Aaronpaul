                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label >Form Four RegNo    <span style="color:red;"></span> </label>
                                <input type="text" class="form-control" name="form_four_regno" value="{{ old('form_four_regno', $getRecord->form_four_regno) }}" 
                                placeholder="Form Four RegNo">
                                <div style="color:red;">{{ $errors->first('form_four_regno') }}</div>
                            </div>
                            <div class="form-group col-md-6">
                                <label >NIDA    <span style="color:red;"></span> </label>
                                <input type="text" class="form-control"  value="{{ old('nida', $getRecord->nida) }}" 
                                name="nida" placeholder="NIDA">
                                <div style="color:red;">{{ $errors->first('nida') }}</div>
                            </div>
