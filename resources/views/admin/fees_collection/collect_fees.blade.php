                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" value="{{ Request::get('first_name')}}" name="first_name"
                    ...
                    @if(!empty($getRecord)) 
                        @forelse($getRecord as $value)
                          ...
                          <tr>
                            ...
                            <td>Tsh {{ number_format( $value->amount,2) }}</td>
                            <td>Tsh {{ number_format( $paid_amount,2 )}}</td>
                            <td>Tsh {{ number_format( $remainingAmount, 2) }}</td>
