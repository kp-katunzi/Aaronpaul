...
<body>
    <div id="page">
        <table style="width: 100%; text-align:center;">
            <tr>
                <td width="5%"></td>
                <td width="15%"><img src="{{ $getSetting->getLogo() }}" 
                style="width: 120px;" ></td>
                <td align="left">
                    <h1>{!! $getSetting->college_name !!} </h1>
                </td>
                <td></td>
            </tr>
        </table>
        ...
        <table class="table-bg">
            <thead>
                <tr>
                    <th class="th text-container ">Subject</th>
                    <th class="th">Test One</th>
                    <th class="th">Test Two</th>
                    <th class="th">Exam</th>
                    <th class="th">Total Score</th>
                    <th class="th">Paasing Marks</th>
            ...
            <tbody>
                ...
                @foreach($getExamMarks as $exam)
                    ...
                    @endphp
                    <tr>
                        <td class="td" style="width: auto; text-align:left">{{ $exam['subject_name']}}</td>
                        <td class="td">{{ $exam['test_one']}}</td>
                        <td class="td">{{ $exam['test_two']}}</td>
